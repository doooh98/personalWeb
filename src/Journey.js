...
const Journey = () => {
  ...
  const bookmarks = [
    ...
    details: 'Began modeling for Agabang at a young age to assist my family during financial challenges and completed kindergarten in Ilsan, South Korea.' },
    { id: 2, color: '#d0ced0', content: '2005-2010', 
    details: 'Studied at Yangcheon Elementary School in Gangseo-gu, Seoul, where I explored my musical talents through participation in school contests and served as student president in sixth grade, encouraged by my peers.' },
