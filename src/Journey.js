...
const Journey = () => {
  ...
  const bookmarks = [
    ...
    { id: 4,
      color: '#c2cbca',
      content: '2014-2018',
      details: "He shared a room with his 3-year-old cousin in his aunt's house in Tennessee. Initially, he learned English and American culture from the welcoming community at Highland Academy in Portland, TN, which helped him overcome the trauma of bullying he had believed he had conquered during his middle school years. This was largely because relationships in the U.S. are not stratified by hierarchy as they often are in Korea. Later, seeking better educational opportunities, he transferred to Lipscomb Academy, he transferred to Lipscomb Academy, where he graduated with a 3.8 GPA, and he founded a culture club to support students who were not familiar with multicultural global environments.\n Although he was not interested in engineering and preferred to major in business, his uncertainty about English as a non-native speaker led him to choose computer science. This field allowed him the freedom for creative activities akin to music. \n Feeling homesick, he continued his education at Virginia Tech, Virginia, an area known for its Korean influences.\n After his first year, during he joined the school's premier dance club, \"Dancing's Our Poison\" out of curiosity about how American culture-based dance teams operate. \n he plans to enlist in the Korean military due to Korean law." },
